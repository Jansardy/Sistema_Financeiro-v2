...
begin
  ...
  begin
    edtSenha.SetFocus;
    Application.MessageBox('Informe a seu nova senha.', 'Atenção', MB_OK + MB_ICONWARNING);
    abort;
  end;
  ...
  begin
    ...
    Application.MessageBox('Confirme a seu nova senha.', 'Atenção', MB_OK + MB_ICONWARNING);
    abort;
  end;
